...
class KeyVerificationModule : public ProtobufModule<water_sensor_mesh_KeyVerification> //, private concurrency::OSThread //
{
    // CallbackObserver<KeyVerificationModule, const water_sensor_mesh::Status *> nodeStatusObserver =
    //     CallbackObserver<KeyVerificationModule, const water_sensor_mesh::Status *>(this, &KeyVerificationModule::handleStatusUpdate);
  ...
  protected:
    ...
    */
    virtual bool handleReceivedProtobuf(const water_sensor_mesh_MeshPacket &mp, water_sensor_mesh_KeyVerification *p);
