...
DPS310Sensor::DPS310Sensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_DPS310, "DPS310") {}
...
bool DPS310Sensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
