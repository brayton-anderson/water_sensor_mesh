...
#if !WATER_SENSOR_MESH_EXCLUDE_ENVIRONMENTAL_SENSOR && defined(SENSECAP_INDICATOR)
...
IndicatorSensor::IndicatorSensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_SENSOR_UNSET, "Indicator") {}
...
bool IndicatorSensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
