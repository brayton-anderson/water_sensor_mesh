...
BME280Sensor::BME280Sensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_BME280, "BME280") {}
...
bool BME280Sensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
