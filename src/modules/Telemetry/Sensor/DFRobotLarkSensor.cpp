...
DFRobotLarkSensor::DFRobotLarkSensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_DFROBOT_LARK, "DFROBOT_LARK") {}
...
bool DFRobotLarkSensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
