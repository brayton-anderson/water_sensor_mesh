...
LTR390UVSensor::LTR390UVSensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_LTR390UV, "LTR390UV") {}
...
bool LTR390UVSensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
