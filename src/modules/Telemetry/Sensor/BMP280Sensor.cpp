...
BMP280Sensor::BMP280Sensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_BMP280, "BMP280") {}
...
bool BMP280Sensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
