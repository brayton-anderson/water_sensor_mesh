...
LPS22HBSensor::LPS22HBSensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_LPS22, "LPS22HB") {}
...
bool LPS22HBSensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
