...
MAX17048Sensor::MAX17048Sensor() : TelemetrySensor(water_sensor_mesh_TelemetrySensorType_MAX17048, "MAX17048") {}
...
bool MAX17048Sensor::getMetrics(water_sensor_mesh_Telemetry *measurement)
{
    ...
    if ((int)measurement->which_variant == water_sensor_mesh_Telemetry_power_metrics_tag) {
        measurement->variant.power_metrics.has_ch1_voltage = true;
        measurement->variant.power_metrics.ch1_voltage = volts;
    } else if ((int)measurement->which_variant == water_sensor_mesh_Telemetry_device_metrics_tag) {
