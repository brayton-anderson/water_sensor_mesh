...
#define AUDIO_MODULE_MODE water_sensor_mesh_ModuleConfig_AudioConfig_Audio_Baud_CODEC2_700

class AudioModule : public SinglePortModule, public Observable<const UIFrameEvent *>, private concurrency::OSThread
{
  public:
    unsigned char rx_encode_frame[water_sensor_mesh_Constants_DATA_PAYLOAD_LEN] = {};
    unsigned char tx_encode_frame[water_sensor_mesh_Constants_DATA_PAYLOAD_LEN] = {};
    c2_header tx_header = {};
