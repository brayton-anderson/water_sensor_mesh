 ...
 */
class PaxcounterModule : private concurrency::OSThread, public ProtobufModule<water_sensor_mesh_Paxcount>
{
    bool firstTime = true;
  ...
  protected:
    ...
    virtual bool handleReceivedProtobuf(const water_sensor_mesh_MeshPacket &mp, water_sensor_mesh_Paxcount *p) override;
