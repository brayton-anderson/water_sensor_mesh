...
const static DetectionSensorTriggerHandler handlers[_water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_MAX + 1] = {
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_LOGIC_LOW] = detection_trigger_logic_level,
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_LOGIC_HIGH] = detection_trigger_logic_level,
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_FALLING_EDGE] = detection_trigger_single_edge,
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_RISING_EDGE] = detection_trigger_single_edge,
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_EITHER_EDGE_ACTIVE_LOW] = detection_trigger_either_edge,
    [water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_EITHER_EDGE_ACTIVE_HIGH] = detection_trigger_either_edge,
};
...
int32_t DetectionSensorModule::runOnce()
{
    ...
    */
    ...
    // water_sensor_mesh_ModuleConfig_DetectionSensorConfig_TriggerType_LOGIC_HIGH;
...
void DetectionSensorModule::sendDetectionMessage()
{
    ...
    if (moduleConfig.detection_sensor.send_bell && p->decoded.payload.size < water_sensor_mesh_Constants_DATA_PAYLOAD_LEN) {
