...
class RangeTestModuleRadio : public SinglePortModule
{
  ...
  public:
    RangeTestModuleRadio() : SinglePortModule("RangeTestModuleRadio", water_sensor_mesh_PortNum_RANGE_TEST_APP)
    {
     ...
     */
    bool appendFile(const water_sensor_mesh_MeshPacket &mp);
