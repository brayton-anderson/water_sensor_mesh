 ...
 */
class RemoteHardwareModule : public ProtobufModule<water_sensor_mesh_HardwareMessage>, private concurrency::OSThread
{
  ...
  protected:
    ...
    */
    virtual bool handleReceivedProtobuf(const water_sensor_mesh_MeshPacket &mp, water_sensor_mesh_HardwareMessage *p) override;
