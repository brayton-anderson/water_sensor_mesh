 ...
 */
class NodeInfoModule : public ProtobufModule<water_sensor_mesh_User>, private concurrency::OSThread
{
  ...
  protected:
    ...
    */
    virtual bool handleReceivedProtobuf(const water_sensor_mesh_MeshPacket &mp, water_sensor_mesh_User *p) override;
