...
#include "main.h"
#include "mesh/generated/water_sensor_mesh/config.pb.h"
#include "meshUtils.h"
...
#if !WATER_SENSOR_MESH_EXCLUDE_WEBSERVER
...
// Global power status
water_sensor_mesh::PowerStatus *powerStatus = new water_sensor_mesh::PowerStatus();

// Global GPS status
water_sensor_mesh::GPSStatus *gpsStatus = new water_sensor_mesh::GPSStatus();

// Global Node status
water_sensor_mesh::NodeStatus *nodeStatus = new water_sensor_mesh::NodeStatus();

// Global Bluetooth status
water_sensor_mesh::BluetoothStatus *bluetoothStatus = new water_sensor_mesh::BluetoothStatus();
...
std::pair<uint8_t, TwoWire *> nodeTelemetrySensorsMap[_water_sensor_mesh_TelemetrySensorType_MAX + 1] = {};
#endif
...
const char *getDeviceName()
{
    ...
    // Water_Sensor_Mesh_ab3c or Shortname_abcd
    static char name[20];
    ...
    if (strcmp(owner.short_name, name) != 0) {
        ...
        snprintf(name, sizeof(name), "Water_Sensor_Mesh_%02x%02x", dmac[4], dmac[5]);
    }
    return name;
}
...
void setup()
{
    ...
    water_sensor_mesh_Config_DisplayConfig_OledType screen_model =
        water_sensor_mesh_Config_DisplayConfig_OledType::water_sensor_mesh_Config_DisplayConfig_OledType_OLED_AUTO;
    ...
    if (screen_found.port != ScanI2C::I2CPort::NO_I2C) {
        ...
        case ScanI2C::DeviceType::SCREEN_SH1106:
            screen_model = water_sensor_mesh_Config_DisplayConfig_OledType::water_sensor_mesh_Config_DisplayConfig_OledType_OLED_SH1106;
            break;
        case ScanI2C::DeviceType::SCREEN_SSD1306:
            screen_model = water_sensor_mesh_Config_DisplayConfig_OledType::water_sensor_mesh_Config_DisplayConfig_OledType_OLED_SSD1306;
            break;
        case ScanI2C::DeviceType::SCREEN_ST7567:
        case ScanI2C::DeviceType::SCREEN_UNKNOWN:
        default:
            screen_model = water_sensor_mesh_Config_DisplayConfig_OledType::water_sensor_mesh_Config_DisplayConfig_OledType_OLED_AUTO;
        }
    }
...
// Two supported RGB LED currently
    ...
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::BME_680, water_sensor_mesh_TelemetrySensorType_BME680);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::BME_280, water_sensor_mesh_TelemetrySensorType_BME280);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::BMP_280, water_sensor_mesh_TelemetrySensorType_BMP280);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::BMP_3XX, water_sensor_mesh_TelemetrySensorType_BMP3XX);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::BMP_085, water_sensor_mesh_TelemetrySensorType_BMP085);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::INA260, water_sensor_mesh_TelemetrySensorType_INA260);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::INA226, water_sensor_mesh_TelemetrySensorType_INA226);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::INA219, water_sensor_mesh_TelemetrySensorType_INA219);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::INA3221, water_sensor_mesh_TelemetrySensorType_INA3221);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MAX17048, water_sensor_mesh_TelemetrySensorType_MAX17048);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MCP9808, water_sensor_mesh_TelemetrySensorType_MCP9808);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::SHT31, water_sensor_mesh_TelemetrySensorType_SHT31);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::SHTC3, water_sensor_mesh_TelemetrySensorType_SHTC3);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::LPS22HB, water_sensor_mesh_TelemetrySensorType_LPS22);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::QMC6310, water_sensor_mesh_TelemetrySensorType_QMC6310);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::QMI8658, water_sensor_mesh_TelemetrySensorType_QMI8658);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::QMC5883L, water_sensor_mesh_TelemetrySensorType_QMC5883L);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::HMC5883L, water_sensor_mesh_TelemetrySensorType_QMC5883L);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::PMSA0031, water_sensor_mesh_TelemetrySensorType_PMSA003I);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::RCWL9620, water_sensor_mesh_TelemetrySensorType_RCWL9620);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::VEML7700, water_sensor_mesh_TelemetrySensorType_VEML7700);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::TSL2591, water_sensor_mesh_TelemetrySensorType_TSL25911FN);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::OPT3001, water_sensor_mesh_TelemetrySensorType_OPT3001);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MLX90632, water_sensor_mesh_TelemetrySensorType_MLX90632);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MLX90614, water_sensor_mesh_TelemetrySensorType_MLX90614);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::SHT4X, water_sensor_mesh_TelemetrySensorType_SHT4X);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::AHT10, water_sensor_mesh_TelemetrySensorType_AHT10);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::DFROBOT_LARK, water_sensor_mesh_TelemetrySensorType_DFROBOT_LARK);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::ICM20948, water_sensor_mesh_TelemetrySensorType_ICM20948);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MAX30102, water_sensor_mesh_TelemetrySensorType_MAX30102);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::CGRADSENS, water_sensor_mesh_TelemetrySensorType_RADSENS);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::DFROBOT_RAIN, water_sensor_mesh_TelemetrySensorType_DFROBOT_RAIN);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::LTR390UV, water_sensor_mesh_TelemetrySensorType_LTR390UV);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::DPS310, water_sensor_mesh_TelemetrySensorType_DPS310);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::RAK12035, water_sensor_mesh_TelemetrySensorType_RAK12035);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::PCT2075, water_sensor_mesh_TelemetrySensorType_PCT2075);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::SCD4X, water_sensor_mesh_TelemetrySensorType_SCD4X);
    ...
    if (config.display.oled != water_sensor_mesh_Config_DisplayConfig_OledType_OLED_AUTO)
        screen_model = config.display.oled;

#if defined(USE_SH1107)
    screen_model = water_sensor_mesh_Config_DisplayConfig_OledType_OLED_SH1107; // set dimension of 128x128
    screen_geometry = GEOMETRY_128_128;
#endif

#if defined(USE_SH1107_128_64)
    screen_model = water_sensor_mesh_Config_DisplayConfig_OledType_OLED_SH1107; // keep dimension of 128x64
#endif
...
#if !WATER_SENSOR_MESH_EXCLUDE_TZ
    ...
    if (config.network.enabled_protocols & water_sensor_mesh_Config_NetworkConfig_ProtocolFlags_UDP_BROADCAST) {
        udpHandler->start();
    }
#endif
#endif
...
#ifdef HAS_PMU
    if (!pmu_found)
        RECORD_CRITICALERROR(water_sensor_mesh_CriticalErrorCode_NO_AXP192); // Record a hardware fault for missing hardware
#endif
...
// the current region name)
    ...
    if ((!rIf) && (config.lora.region != water_sensor_mesh_Config_LoRaConfig_RegionCode_LORA_24)) {
    ...
    if ((config.lora.region == water_sensor_mesh_Config_LoRaConfig_RegionCode_LORA_24) && (!rIf->wideLora())) {
...
#if defined(ARCH_ESP32) && !WATER_SENSOR_MESH_EXCLUDE_WEBSERVER
    ...
    if (!rIf)
        RECORD_CRITICALERROR(water_sensor_mesh_CriticalErrorCode_NO_RADIO);
    else {
        router->addInterface(rIf);

        // Log bit rate to debug output
        LOG_DEBUG("LoRA bitrate = %f bytes / sec", (float(water_sensor_mesh_Constants_DATA_PAYLOAD_LEN) /
                                                    (float(rIf->getPacketTime(water_sensor_mesh_Constants_DATA_PAYLOAD_LEN)))) *
                                                       1000);
    }
...
extern water_sensor_mesh_DeviceMetadata getDeviceMetadata()
{
    water_sensor_mesh_DeviceMetadata deviceMetadata;
    ...
    deviceMetadata.excluded_modules = water_sensor_mesh_ExcludedModules_EXCLUDED_NONE;
#if WATER_SENSOR_MESH_EXCLUDE_REMOTEHARDWARE
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_REMOTEHARDWARE_CONFIG;
#endif
#if WATER_SENSOR_MESH_EXCLUDE_AUDIO
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_AUDIO_CONFIG;
#endif
// Option to explicitly include canned messages for edge cases, e.g. niche graphics
#if ((!HAS_SCREEN || NO_EXT_GPIO) || WATER_SENSOR_MESH_EXCLUDE_CANNEDMESSAGES) && !defined(WATER_SENSOR_MESH_INCLUDE_NICHE_GRAPHICS)
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_CANNEDMSG_CONFIG;
#endif
#if NO_EXT_GPIO
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_EXTNOTIF_CONFIG;
#endif
// Only edge case here is if we apply this a device with built in Accelerometer and want to detect interrupts
// We'll have to macro guard against those targets potentially
#if NO_EXT_GPIO || WATER_SENSOR_MESH_EXCLUDE_DETECTIONSENSOR
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_DETECTIONSENSOR_CONFIG;
#endif
// If we don't have any GPIO and we don't have GPS OR we don't want too - no purpose in having serial config
#if NO_EXT_GPIO && NO_GPS || WATER_SENSOR_MESH_EXCLUDE_SERIAL
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_SERIAL_CONFIG;
#endif
#ifndef ARCH_ESP32
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_PAXCOUNTER_CONFIG;
#endif
#if !defined(HAS_RGB_LED) && !RAK_4631
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_AMBIENTLIGHTING_CONFIG;
#endif
...
// Portduino and ESP32-C6 are excluded because we don't have a working bluetooth stacks integrated yet.
    ...
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_BLUETOOTH_CONFIG;
#endif

#if defined(ARCH_NRF52) && !HAS_ETHERNET // nrf52 doesn't have network unless it's a RAK ethernet gateway currently
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_NETWORK_CONFIG; // No network on nRF52
#elif defined(ARCH_RP2040) && !HAS_WIFI && !HAS_ETHERNET
    deviceMetadata.excluded_modules |= water_sensor_mesh_ExcludedModules_NETWORK_CONFIG; // No network on RP2040
#endif
...
void scannerToSensorsMap(const std::unique_ptr<ScanI2CTwoWire> &i2cScanner, ScanI2C::DeviceType deviceType,
                         water_sensor_mesh_TelemetrySensorType sensorType)
{
...
void loop()
{
    ...
    if (!Throttle::isWithinTimespanMs(lastPrint, 10 * 1000L)) {
        lastPrint = millis();
        water_sensor_mesh::printThreadInfo("main");
    }
#endif
