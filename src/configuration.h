...
// #define REGULATORY_LORA_REGIONCODE water_sensor_mesh_Config_LoRaConfig_RegionCode_SG_923
...
// #define WATER_SENSOR_MESH_MINIMIZE_BUILD 1
#ifdef WATER_SENSOR_MESH_MINIMIZE_BUILD
#define WATER_SENSOR_MESH_EXCLUDE_MODULES 1
#define WATER_SENSOR_MESH_EXCLUDE_WIFI 1
#define WATER_SENSOR_MESH_EXCLUDE_BLUETOOTH 1
#define WATER_SENSOR_MESH_EXCLUDE_GPS 1
#define WATER_SENSOR_MESH_EXCLUDE_SCREEN 1
#define WATER_SENSOR_MESH_EXCLUDE_MQTT 1
#define WATER_SENSOR_MESH_EXCLUDE_POWERMON 1
#define WATER_SENSOR_MESH_EXCLUDE_I2C 1
#define WATER_SENSOR_MESH_EXCLUDE_PKI 1
#define WATER_SENSOR_MESH_EXCLUDE_POWER_FSM 1
#define WATER_SENSOR_MESH_EXCLUDE_TZ 1
#endif

// Turn off all optional modules
#ifdef WATER_SENSOR_MESH_EXCLUDE_MODULES
#define WATER_SENSOR_MESH_EXCLUDE_AUDIO 1
#define WATER_SENSOR_MESH_EXCLUDE_DETECTIONSENSOR 1
#define WATER_SENSOR_MESH_EXCLUDE_ENVIRONMENTAL_SENSOR 1
#define WATER_SENSOR_MESH_EXCLUDE_HEALTH_TELEMETRY 1
#define WATER_SENSOR_MESH_EXCLUDE_EXTERNALNOTIFICATION 1
#define WATER_SENSOR_MESH_EXCLUDE_PAXCOUNTER 1
#define WATER_SENSOR_MESH_EXCLUDE_POWER_TELEMETRY 1
#define WATER_SENSOR_MESH_EXCLUDE_RANGETEST 1
#define WATER_SENSOR_MESH_EXCLUDE_REMOTEHARDWARE 1
#define WATER_SENSOR_MESH_EXCLUDE_STOREFORWARD 1
#define WATER_SENSOR_MESH_EXCLUDE_TEXTMESSAGE 1
#define WATER_SENSOR_MESH_EXCLUDE_ATAK 1
#define WATER_SENSOR_MESH_EXCLUDE_CANNEDMESSAGES 1
#define WATER_SENSOR_MESH_EXCLUDE_NEIGHBORINFO 1
#define WATER_SENSOR_MESH_EXCLUDE_TRACEROUTE 1
#define WATER_SENSOR_MESH_EXCLUDE_WAYPOINT 1
#define WATER_SENSOR_MESH_EXCLUDE_INPUTBROKER 1
#define WATER_SENSOR_MESH_EXCLUDE_SERIAL 1
#define WATER_SENSOR_MESH_EXCLUDE_POWERSTRESS 1
#define WATER_SENSOR_MESH_EXCLUDE_ADMIN 1
#endif

// // Turn off wifi even if HW supports wifi (webserver relies on wifi and is also disabled)
#ifdef WATER_SENSOR_MESH_EXCLUDE_WIFI
#define WATER_SENSOR_MESH_EXCLUDE_WEBSERVER 1
#undef HAS_WIFI
#define HAS_WIFI 0
#endif
...
// // Turn off Bluetooth
#ifdef WATER_SENSOR_MESH_EXCLUDE_BLUETOOTH
#undef HAS_BLUETOOTH
#define HAS_BLUETOOTH 0
#endif

// // Turn off GPS
#ifdef WATER_SENSOR_MESH_EXCLUDE_GPS
#undef HAS_GPS
#define HAS_GPS 0
#undef WATER_SENSOR_MESH_EXCLUDE_RANGETEST
#define WATER_SENSOR_MESH_EXCLUDE_RANGETEST 1
#endif

// Turn off Screen
#ifdef WATER_SENSOR_MESH_EXCLUDE_SCREEN
#undef HAS_SCREEN
#define HAS_SCREEN 0
#endif
