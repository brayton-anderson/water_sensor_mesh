...
static const String WATER_SENSOR_MESH_OTA_APP_PROJECT_NAME("Water_Sensor_Mesh-OTA");
...
const esp_partition_t *BleOta::findEspOtaAppPartition()
{
    ...
    if (ret != ESP_OK || WATER_SENSOR_MESH_OTA_APP_PROJECT_NAME != app_desc.project_name) {
