...
#include <RNG.h>
#include <SHA256.h>
#if !(WATER_SENSOR_MESH_EXCLUDE_PKI_KEYGEN)
 ...
 */
bool CryptoEngine::encryptCurve25519(uint32_t toNode, uint32_t fromNode, water_sensor_mesh_UserLite_public_key_t remotePublic,
 ...
 */
bool CryptoEngine::decryptCurve25519(uint32_t fromNode, water_sensor_mesh_UserLite_public_key_t remotePublic, uint64_t packetNum,
