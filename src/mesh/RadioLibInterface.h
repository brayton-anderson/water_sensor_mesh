...
#define WATER_SENSOR_MESH_RADIOLIB_IRQ_RX_FLAGS (RADIOLIB_IRQ_RX_DEFAULT_FLAGS | (1 << RADIOLIB_IRQ_PREAMBLE_DETECTED))
...
class RadioLibInterface : public RadioInterface, protected concurrency::NotifiedWorkerThread
{
  ...
  protected:
    /**
     * We use a water_sensor_mesh sync word, but hashed with the Channel name.  For releases before 1.2 we used 0x12 (or for very old
  ...
  private:
     ...
     */
    virtual bool startSend(water_sensor_mesh_MeshPacket *txp);

    water_sensor_mesh_QueueStatus getQueueStatus();
  ...
  protected:
     ...
     */
    virtual void addReceiveMetadata(water_sensor_mesh_MeshPacket *mp) = 0;
