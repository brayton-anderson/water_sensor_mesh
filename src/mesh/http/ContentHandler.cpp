...
void handleAPIv1FromRadio(HTTPRequest *req, HTTPResponse *res)
{
    ...
    /*
        For documentation, see:
            https://water_sensor_mesh.org/docs/development/device/http-api
            https://water_sensor_mesh.org/docs/development/device/client-api
    */
    ...
    res->setHeader("X-Protobuf-Schema", "https://raw.githubusercontent.com/water_sensor_mesh/protobufs/master/water_sensor_mesh/mesh.proto");
        ...
        if (FSCom.exists(filename.c_str())) {
            ...
            if (!file.available()) {
                ...
                res->println("Web server is running.<br><br>The content you are looking for can't be found. Please see: <a "
                             "href=https://water_sensor_mesh.org/docs/software/web-client/>FAQ</a>.<br><br><a "
                             "href=/admin>admin</a>");
...
void handleDeleteFsContent(HTTPRequest *req, HTTPResponse *res)
{
    ...
    res->println("<h1>Water_Sensor_Mesh</h1>");
