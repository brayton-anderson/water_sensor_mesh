...
bool PhoneAPI::handleToRadio(const uint8_t *buf, size_t bufLength)
{
    ...
    if (pb_decode_from_bytes(buf, bufLength, &water_sensor_mesh_ToRadio_msg, &toRadioScratch)) {
        switch (toRadioScratch.which_payload_variant) {
        case water_sensor_mesh_ToRadio_packet_tag:
            return handleToRadioPacket(toRadioScratch.packet);
        case water_sensor_mesh_ToRadio_want_config_id_tag:
            config_nonce = toRadioScratch.want_config_id;
            LOG_INFO("Client wants config, nonce=%u", config_nonce);
            handleStartConfig();
            break;
        case water_sensor_mesh_ToRadio_disconnect_tag:
            LOG_INFO("Disconnect from phone");
            close();
            break;
        case water_sensor_mesh_ToRadio_xmodemPacket_tag:
            ...
            break;
#if !WATER_SENSOR_MESH_EXCLUDE_MQTT
        case water_sensor_mesh_ToRadio_mqttClientProxyMessage_tag:
            ...
            break;
#endif
        case water_sensor_mesh_ToRadio_heartbeat_tag:
...
size_t PhoneAPI::getFromRadio(uint8_t *buf)
{
    ...
    case STATE_SEND_MY_INFO:
        ...
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_my_info_tag;
    ...
    case STATE_SEND_UIDATA:
        ...
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_deviceuiConfig_tag;
    ...
    case STATE_SEND_OWN_NODEINFO: {
        ...
        if (us) {
            ...
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_node_info_tag;
    ...
    case STATE_SEND_METADATA:
        ...
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_metadata_tag;
        fromRadioScratch.metadata = getDeviceMetadata();
        state = STATE_SEND_CHANNELS;
        break;

    case STATE_SEND_CHANNELS:
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_channel_tag;
        ...
        if (config_state >= MAX_NUM_CHANNELS) {
            ...
            config_state = _water_sensor_mesh_AdminMessage_ConfigType_MIN + 1;
        }
        break;

    case STATE_SEND_CONFIG:
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_config_tag;
        switch (config_state) {
        case water_sensor_mesh_Config_device_tag:
            LOG_DEBUG("Send config: device");
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_device_tag;
        ...
        case water_sensor_mesh_Config_position_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_position_tag;
        ...
        case water_sensor_mesh_Config_power_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_power_tag;
        ...
        case water_sensor_mesh_Config_network_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_network_tag;
        ...
        case water_sensor_mesh_Config_display_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_display_tag;
        ...
        case water_sensor_mesh_Config_lora_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_lora_tag;
        ...
        case water_sensor_mesh_Config_bluetooth_tag:
            ...
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_bluetooth_tag;
            fromRadioScratch.config.payload_variant.bluetooth = config.bluetooth;
            break;
        case water_sensor_mesh_Config_security_tag:
            LOG_DEBUG("Send config: security");
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_security_tag;
            fromRadioScratch.config.payload_variant.security = config.security;
            break;
        case water_sensor_mesh_Config_sessionkey_tag:
            LOG_DEBUG("Send config: sessionkey");
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_sessionkey_tag;
            break;
        case water_sensor_mesh_Config_device_ui_tag: // NOOP!
            fromRadioScratch.config.which_payload_variant = water_sensor_mesh_Config_device_ui_tag;
            break;
        default:
        ...
        if (config_state > (_water_sensor_mesh_AdminMessage_ConfigType_MAX + 1)) {
            state = STATE_SEND_MODULECONFIG;
            config_state = _water_sensor_mesh_AdminMessage_ModuleConfigType_MIN + 1;
        }
        break;

    case STATE_SEND_MODULECONFIG:
        fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_moduleConfig_tag;
        switch (config_state) {
        case water_sensor_mesh_ModuleConfig_mqtt_tag:
            LOG_DEBUG("Send module config: mqtt");
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_mqtt_tag;
        ...
        case water_sensor_mesh_ModuleConfig_serial_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_serial_tag;
        ...
        case water_sensor_mesh_ModuleConfig_external_notification_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_external_notification_tag;
        ...
        case water_sensor_mesh_ModuleConfig_store_forward_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_store_forward_tag;
        ...
        case water_sensor_mesh_ModuleConfig_range_test_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_range_test_tag;
        ...
        case water_sensor_mesh_ModuleConfig_telemetry_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_telemetry_tag;
        ...
        case water_sensor_mesh_ModuleConfig_canned_message_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_canned_message_tag;
            fromRadioScratch.moduleConfig.payload_variant.canned_message = moduleConfig.canned_message;
            break;
        case water_sensor_mesh_ModuleConfig_audio_tag:
            LOG_DEBUG("Send module config: audio");
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_audio_tag;
        ...
        case water_sensor_mesh_ModuleConfig_remote_hardware_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_remote_hardware_tag;
        ...
        case water_sensor_mesh_ModuleConfig_neighbor_info_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_neighbor_info_tag;
        ...
        case water_sensor_mesh_ModuleConfig_detection_sensor_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_detection_sensor_tag;
        ...
        case water_sensor_mesh_ModuleConfig_ambient_lighting_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_ambient_lighting_tag;
        ...
        case water_sensor_mesh_ModuleConfig_paxcounter_tag:
            ...
            fromRadioScratch.moduleConfig.which_payload_variant = water_sensor_mesh_ModuleConfig_paxcounter_tag;
        ...
        if (config_state > (_water_sensor_mesh_AdminMessage_ModuleConfigType_MAX + 1)) {
    ...
    case STATE_SEND_FILEMANIFEST: {
        ...
        if (config_state == filesManifest.size() ||
            ...
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_fileInfo_tag;
    ...
    case STATE_SEND_PACKETS:
        ...
        if (queueStatusPacketForPhone) {
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_queueStatus_tag;
            fromRadioScratch.queueStatus = *queueStatusPacketForPhone;
            releaseQueueStatusPhonePacket();
        } else if (mqttClientProxyMessageForPhone) {
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_mqttClientProxyMessage_tag;
            fromRadioScratch.mqttClientProxyMessage = *mqttClientProxyMessageForPhone;
            releaseMqttClientProxyPhonePacket();
        } else if (xmodemPacketForPhone.control != water_sensor_mesh_XModem_Control_NUL) {
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_xmodemPacket_tag;
            fromRadioScratch.xmodemPacket = xmodemPacketForPhone;
            xmodemPacketForPhone = water_sensor_mesh_XModem_init_zero;
        } else if (clientNotification) {
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_clientNotification_tag;
            ...
            fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_packet_tag;
    ...
    if (fromRadioScratch.which_payload_variant != 0) {
        // Encapsulate as a FromRadio packet
        size_t numbytes = pb_encode_to_bytes(buf, water_sensor_mesh_FromRadio_size, &water_sensor_mesh_FromRadio_msg, &fromRadioScratch);
...
void PhoneAPI::sendConfigComplete()
{
    ...
    fromRadioScratch.which_payload_variant = water_sensor_mesh_FromRadio_config_complete_id_tag;
...
#ifdef FSCom
        if (xmodemPacketForPhone.control == water_sensor_mesh_XModem_Control_NUL)
...
void PhoneAPI::sendNotification(water_sensor_mesh_LogRecord_Level level, uint32_t replyId, const char *message)
{
 ...
 */
bool PhoneAPI::handleToRadioPacket(water_sensor_mesh_MeshPacket &p)
{
    ...
    if (p.decoded.portnum == water_sensor_mesh_PortNum_TRACEROUTE_APP && lastPortNumToRadio[p.decoded.portnum] &&
        Throttle::isWithinTimespanMs(lastPortNumToRadio[p.decoded.portnum], THIRTY_SECONDS_MS)) {
        LOG_WARN("Rate limit portnum %d", p.decoded.portnum);
        sendNotification(water_sensor_mesh_LogRecord_Level_WARNING, p.id, "TraceRoute can only be sent once every 30 seconds");
        water_sensor_mesh_QueueStatus qs = router->getQueueStatus();
        service->sendQueueStatusToPhone(qs, 0, p.id);
        return false;
    } else if (p.decoded.portnum == water_sensor_mesh_PortNum_TRACEROUTE_APP && isBroadcast(p.to) && p.hop_limit > 0) {
        sendNotification(water_sensor_mesh_LogRecord_Level_WARNING, p.id, "Multi-hop traceroute to broadcast address is not allowed");
        water_sensor_mesh_QueueStatus qs = router->getQueueStatus();
        service->sendQueueStatusToPhone(qs, 0, p.id);
        return false;
    } else if (IS_ONE_OF(p.decoded.portnum, water_sensor_mesh_PortNum_POSITION_APP, water_sensor_mesh_PortNum_WAYPOINT_APP,
                         water_sensor_mesh_PortNum_ALERT_APP, water_sensor_mesh_PortNum_TELEMETRY_APP) &&
        ...
        // sendNotification(water_sensor_mesh_LogRecord_Level_WARNING, p.id, "Position can only be sent once every 5 seconds");
        return false;
    } else if (p.decoded.portnum == water_sensor_mesh_PortNum_TEXT_MESSAGE_APP && lastPortNumToRadio[p.decoded.portnum] &&
               Throttle::isWithinTimespanMs(lastPortNumToRadio[p.decoded.portnum], TWO_SECONDS_MS)) {
        LOG_WARN("Rate limit portnum %d", p.decoded.portnum);
        water_sensor_mesh_QueueStatus qs = router->getQueueStatus();
        service->sendQueueStatusToPhone(qs, 0, p.id);
        sendNotification(water_sensor_mesh_LogRecord_Level_WARNING, p.id, "Text messages can only be sent once every 2 seconds");
        return false;
    }
