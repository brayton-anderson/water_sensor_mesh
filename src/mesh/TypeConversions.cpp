...
water_sensor_mesh_NodeInfo TypeConversions::ConvertToNodeInfo(const water_sensor_mesh_NodeInfoLite *lite)
{
    water_sensor_mesh_NodeInfo info = water_sensor_mesh_NodeInfo_init_default;
...
water_sensor_mesh_PositionLite TypeConversions::ConvertToPositionLite(water_sensor_mesh_Position position)
{
    water_sensor_mesh_PositionLite lite = water_sensor_mesh_PositionLite_init_default;
...
water_sensor_mesh_Position TypeConversions::ConvertToPosition(water_sensor_mesh_PositionLite lite)
{
    water_sensor_mesh_Position position = water_sensor_mesh_Position_init_default;
...
water_sensor_mesh_UserLite TypeConversions::ConvertToUserLite(water_sensor_mesh_User user)
{
    water_sensor_mesh_UserLite lite = water_sensor_mesh_UserLite_init_default;
...
water_sensor_mesh_User TypeConversions::ConvertToUser(uint32_t nodeNum, water_sensor_mesh_UserLite lite)
{
    water_sensor_mesh_User user = water_sensor_mesh_User_init_default;
