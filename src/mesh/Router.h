...
class Router : protected concurrency::OSThread, protected PacketHistory
{
  private:
    ...
    PointerQueue<water_sensor_mesh_MeshPacket> fromRadioQueue;
  ...
  public:
     ...
     */
    ErrorCode sendLocal(water_sensor_mesh_MeshPacket *p, RxSource src = RX_SRC_RADIO);
     ...
     */
    water_sensor_mesh_MeshPacket *allocForSending();
     ...
     * freeing the packet
     */
    virtual void enqueueReceivedMessage(water_sensor_mesh_MeshPacket *p);
     ...
     * NOTE: This method will free the provided packet (even if we return an error code)
     */
    virtual ErrorCode send(water_sensor_mesh_MeshPacket *p);
    virtual ErrorCode rawSend(water_sensor_mesh_MeshPacket *p);
  ...
  protected:
     ...
     */
    virtual bool shouldFilterReceived(const water_sensor_mesh_MeshPacket *p) { return false; }

    /**
     * Every (non duplicate) packet this node receives will be passed through this method.  This allows subclasses to
     * update routing tables etc... based on what we overhear (even for messages not destined to our node)
     */
    virtual void sniffReceived(const water_sensor_mesh_MeshPacket *p, const water_sensor_mesh_Routing *c);

    /**
     * Send an ack or a nak packet back towards whoever sent idFrom
     */
    void sendAckNak(water_sensor_mesh_Routing_Error err, NodeNum to, PacketId idFrom, ChannelIndex chIndex, uint8_t hopLimit = 0);
  ...
  private:
     ...
     */
    void perhapsHandleReceived(water_sensor_mesh_MeshPacket *p);
     ...
     * Note: this method will free the provided packet.
     */
    void handleReceived(water_sensor_mesh_MeshPacket *p, RxSource src = RX_SRC_RADIO);

    /** Frees the provided packet, and generates a NAK indicating the specifed error while sending */
    void abortSendAndNak(water_sensor_mesh_Routing_Error err, water_sensor_mesh_MeshPacket *p);
};
