...
class CryptoEngine
{
  public:
    ...
    virtual bool encryptCurve25519(uint32_t toNode, uint32_t fromNode, water_sensor_mesh_UserLite_public_key_t remotePublic,
                                   uint64_t packetNum, size_t numBytes, const uint8_t *bytes, uint8_t *bytesOut);
    virtual bool decryptCurve25519(uint32_t fromNode, water_sensor_mesh_UserLite_public_key_t remotePublic, uint64_t packetNum,
