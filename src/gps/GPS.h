...
class GPS : private concurrency::OSThread
{
  public:
    ...
    Observable<const water_sensor_mesh::GPSStatus *> newStatus;
    ...
    bool isPowerSaving() const { return config.position.gps_mode != water_sensor_mesh_Config_PositionConfig_GpsMode_ENABLED; }
