...
uint32_t printWPL(char *buf, size_t bufsz, const water_sensor_mesh_PositionLite &pos, const char *name, bool isCaltopoMode)
{
...
uint32_t printWPL(char *buf, size_t bufsz, const water_sensor_mesh_Position &pos, const char *name, bool isCaltopoMode)
{
    GeoCoord geoCoord(pos.latitude_i, pos.longitude_i, pos.altitude);
    char type = isCaltopoMode ? 'P' : 'N';
