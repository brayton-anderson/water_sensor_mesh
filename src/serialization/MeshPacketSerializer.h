...
{
  public:
    static std::string JsonSerialize(const water_sensor_mesh_MeshPacket *mp, bool shouldLog = true);
    static std::string JsonSerializeEncrypted(const water_sensor_mesh_MeshPacket *mp);
