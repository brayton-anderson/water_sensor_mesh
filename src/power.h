...
class Power : private concurrency::OSThread
{
  ...
  public:
    Observable<const water_sensor_mesh::PowerStatus *> newStatus;
    ...
    void setStatusHandler(water_sensor_mesh::PowerStatus *handler) { statusHandler = handler; }
    const uint16_t OCV[11] = {OCV_ARRAY};

  protected:
    water_sensor_mesh::PowerStatus *statusHandler;
