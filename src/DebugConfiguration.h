...
#define WATER_SENSOR_MESH_LOG_LEVEL_DEBUG "DEBUG"
#define WATER_SENSOR_MESH_LOG_LEVEL_INFO "INFO "
#define WATER_SENSOR_MESH_LOG_LEVEL_WARN "WARN "
#define WATER_SENSOR_MESH_LOG_LEVEL_ERROR "ERROR"
#define WATER_SENSOR_MESH_LOG_LEVEL_CRIT "CRIT "
#define WATER_SENSOR_MESH_LOG_LEVEL_TRACE "TRACE"
...
#define LOG_DEBUG(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_DEBUG, __VA_ARGS__)
#define LOG_INFO(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_INFO, __VA_ARGS__)
#define LOG_WARN(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_WARN, __VA_ARGS__)
#define LOG_ERROR(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_ERROR, __VA_ARGS__)
#define LOG_CRIT(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_CRIT, __VA_ARGS__)
#define LOG_TRACE(...) DEBUG_PORT.log(WATER_SENSOR_MESH_LOG_LEVEL_TRACE, __VA_ARGS__)
#else
#define LOG_DEBUG(...)
#define LOG_INFO(...)
#define LOG_WARN(...)
...
/// A C wrapper for LOG_DEBUG that can be used from arduino C libs that don't know about C++ or water_sensor_mesh
