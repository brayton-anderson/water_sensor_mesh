...
#if !defined(ARCH_STM32WL) && !WATER_SENSOR_MESH_EXCLUDE_I2C && __has_include(<ICM_20948.h>)
#if !defined(WATER_SENSOR_MESH_EXCLUDE_SCREEN)
...
int32_t ICM20948Sensor::runOnce()
{
#if !defined(WATER_SENSOR_MESH_EXCLUDE_SCREEN) && HAS_SCREEN
    ...
    if (config.display.compass_orientation > water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_270) {
    ...
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_0_INVERTED:
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_0:
        break;
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_90:
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_90_INVERTED:
        heading += 90;
        break;
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_180:
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_180_INVERTED:
        heading += 180;
        break;
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_270:
    case water_sensor_mesh_Config_DisplayConfig_CompassOrientation_DEGREES_270_INVERTED:
        heading += 270;
        break;
    }
    if (screen)
