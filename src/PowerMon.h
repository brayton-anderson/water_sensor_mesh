...
#ifndef WATER_SENSOR_MESH_EXCLUDE_POWERMON
...
class PowerMon
{
  ...
  public:
    ...
    void setState(_water_sensor_mesh_PowerMon_State state, const char *reason = "");
    void clearState(_water_sensor_mesh_PowerMon_State state, const char *reason = "");
