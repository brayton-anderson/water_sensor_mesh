...
/*
  ...
  RX_ALL_LOG  - Time of all received lora packets. This includes packets that are not
                for water_sensor_mesh devices. Does not include TX air time.

  Example analytics:

  TX_LOG + RX_LOG = Total air time for a particular water_sensor_mesh channel.

  TX_LOG + RX_LOG = Total air time for a particular water_sensor_mesh channel, including
                    other lora radios.
