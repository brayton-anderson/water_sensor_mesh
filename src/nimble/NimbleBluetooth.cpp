...
class BluetoothPhoneAPI : public PhoneAPI, public concurrency::OSThread
{
  public:
    ...
    uint8_t fromRadioBytes[water_sensor_mesh_FromRadio_size] = {0};
    size_t numBytes = 0;
...
class NimbleBluetoothServerCallback : public NimBLEServerCallbacks
{
    virtual uint32_t onPassKeyRequest()
    {
        ...
        if (config.bluetooth.mode == water_sensor_mesh_Config_BluetoothConfig_PairingMode_RANDOM_PIN) {
        ...
        bluetoothStatus->updateStatus(new water_sensor_mesh::BluetoothStatus(std::to_string(passkey)));
