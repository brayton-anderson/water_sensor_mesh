...
#include "NodeDB.h"
#include "SPILock.h"
#include "generated/water_sensor_mesh/cannedmessages.pb.h"
...
void CannedMessageStore::load()
{
    ...
    LoadFileResult result = nodeDB->loadProto("/prefs/cannedConf.proto", water_sensor_mesh_CannedMessageModuleConfig_size,
                                              sizeof(water_sensor_mesh_CannedMessageModuleConfig),
...
// Client API changing the canned messages
void CannedMessageStore::handleSet(const water_sensor_mesh_AdminMessage *request)
{
    ...
    // Write to flash
    nodeDB->saveProto(cannedMessagesConfigFile, water_sensor_mesh_CannedMessageModuleConfig_size,
                      &water_sensor_mesh_CannedMessageModuleConfig_msg, &cannedMessageModuleConfig);
...
void CannedMessageStore::handleGet(water_sensor_mesh_AdminMessage *response)
{
