...
which is a general part of the Water_Sensor_Mesh firmware, and not part of InkHUD.
...
class NewMsgExampleApplet : public Applet, public SinglePortModule
{
  public:
    ...
    NewMsgExampleApplet() : SinglePortModule("NewMsgExampleApplet", water_sensor_mesh_PortNum_TEXT_MESSAGE_APP) {}
