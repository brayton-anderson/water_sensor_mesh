...
int InkHUD::BatteryIconApplet::onPowerStatusUpdate(const water_sensor_mesh::Status *status)
{
    ...
    water_sensor_mesh::PowerStatus *powerStatus = (water_sensor_mesh::PowerStatus *)status;
