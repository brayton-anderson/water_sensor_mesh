...
int InkHUD::PairingApplet::onBluetoothStatusUpdate(const water_sensor_mesh::Status *status)
{
    // The standard Water_Sensor_Mesh convention is to pass these "generic" Status objects,
    ...
    water_sensor_mesh::BluetoothStatus *bluetoothStatus = (water_sensor_mesh::BluetoothStatus *)status;

    // When pairing begins
    if (bluetoothStatus->getConnectionState() == water_sensor_mesh::BluetoothStatus::ConnectionState::PAIRING) {
