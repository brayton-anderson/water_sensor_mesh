...
class NotificationApplet : public SystemApplet
{
  ...
  protected:
    ...
    CallbackObserver<NotificationApplet, const water_sensor_mesh_MeshPacket *> textMessageObserver =
        CallbackObserver<NotificationApplet, const water_sensor_mesh_MeshPacket *>(this, &NotificationApplet::onReceiveTextMessage);
