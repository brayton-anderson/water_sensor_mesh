...
int InkHUD::DMApplet::onReceiveTextMessage(const water_sensor_mesh_MeshPacket *p)
{
...
void InkHUD::DMApplet::onRender()
{
    ...
    // - node id
    water_sensor_mesh_NodeInfoLite *sender = nodeDB->getMeshNode(latestMessage->dm.sender);
