...
class AllMessageApplet : public Applet
{
  ...
  protected:
    ...
    CallbackObserver<AllMessageApplet, const water_sensor_mesh_MeshPacket *> textMessageObserver =
        CallbackObserver<AllMessageApplet, const water_sensor_mesh_MeshPacket *>(this, &AllMessageApplet::onReceiveTextMessage);
};
