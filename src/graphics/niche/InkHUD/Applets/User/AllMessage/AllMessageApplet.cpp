...
int InkHUD::AllMessageApplet::onReceiveTextMessage(const water_sensor_mesh_MeshPacket *p)
{
...
void InkHUD::AllMessageApplet::onRender()
{
    ...
    // - node id
    water_sensor_mesh_NodeInfoLite *sender = nodeDB->getMeshNode(message->sender);
