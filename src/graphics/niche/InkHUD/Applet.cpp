...
constexpr float InkHUD::Applet::LOGO_ASPECT_RATIO; // Ratio of the Water_Sensor_Mesh logo
...
std::string InkHUD::Applet::parseShortName(water_sensor_mesh_NodeInfoLite *node)
{
    assert(node);
...
// "Scale to fit": width of Water_Sensor_Mesh logo to fit given region, maintaining aspect ratio
...
// "Scale to fit": height of Water_Sensor_Mesh logo to fit given region, maintaining aspect ratio
...
// Draw a scalable Water_Sensor_Mesh logo
...
void InkHUD::Applet::drawLogo(int16_t centerX, int16_t centerY, uint16_t width, uint16_t height, Color color)
{
    ...
    int16_t logoTh = width * 0.068; // Thickness scales with width. Measured from logo at water_sensor_mesh.org.
