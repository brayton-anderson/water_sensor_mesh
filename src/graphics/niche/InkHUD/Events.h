...
class Events
{
  public:
    ...
    int onReceiveTextMessage(const water_sensor_mesh_MeshPacket *packet); // Store most recent text message
  ...
  private:
    ...
    CallbackObserver<Events, const water_sensor_mesh_MeshPacket *> textMessageObserver =
        CallbackObserver<Events, const water_sensor_mesh_MeshPacket *>(this, &Events::onReceiveTextMessage);
