...
class Screen
{
  public:
    ...
    explicit Screen(ScanI2C::DeviceAddress, water_sensor_mesh_Config_DisplayConfig_OledType, OLEDDISPLAY_GEOMETRY);
    void onPress() {}
    void setup() {}
    void setOn(bool) {}
    void doDeepSleep() {}
...
{
    CallbackObserver<Screen, const water_sensor_mesh::Status *> powerStatusObserver =
        CallbackObserver<Screen, const water_sensor_mesh::Status *>(this, &Screen::handleStatusUpdate);
    CallbackObserver<Screen, const water_sensor_mesh::Status *> gpsStatusObserver =
        CallbackObserver<Screen, const water_sensor_mesh::Status *>(this, &Screen::handleStatusUpdate);
    CallbackObserver<Screen, const water_sensor_mesh::Status *> nodeStatusObserver =
        CallbackObserver<Screen, const water_sensor_mesh::Status *>(this, &Screen::handleStatusUpdate);
    CallbackObserver<Screen, const water_sensor_mesh_MeshPacket *> textMessageObserver =
        CallbackObserver<Screen, const water_sensor_mesh_MeshPacket *>(this, &Screen::handleTextMessage);
  ...
  public:
    ...
    water_sensor_mesh_Config_DisplayConfig_OledType model;
    ...
    int handleStatusUpdate(const water_sensor_mesh::Status *arg);
    int handleTextMessage(const water_sensor_mesh_MeshPacket *arg);
