...
class GPSStatus : public Status
{
  ...
  private:
    ...
    water_sensor_mesh_Position p = water_sensor_mesh_Position_init_default;

  public:
    GPSStatus() { statusType = STATUS_TYPE_GPS; }

    // preferred method
    GPSStatus(bool hasLock, bool isConnected, bool isPowerSaving, const water_sensor_mesh_Position &pos) : Status()
    {
...
extern water_sensor_mesh::GPSStatus *gpsStatus;
