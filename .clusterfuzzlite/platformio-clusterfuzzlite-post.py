"""PlatformIO build script (post: runs after other Water_Sensor_Mesh scripts)."""
...
# before Water_Sensor_Mesh is started. We rename the "main" function for Water_Sensor_Mesh to
