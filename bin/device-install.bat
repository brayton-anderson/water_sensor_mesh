...
TITLE Water_Sensor_Mesh device-install
...
@REM https://github.com/water_sensor_mesh/web-flasher/blob/main/types/resources.ts#L3
...
@REM Default offsets.
@REM https://github.com/water_sensor_mesh/web-flasher/blob/main/stores/firmwareStore.ts#L202
