...
print("Using water_sensor_mesh platformio-custom.py, firmware version " + verObj["long"] + " on " + env.get("PIOENV"))
...
for pref in userPrefs:
    if userPrefs[pref].startswith("{"):
        ...
        pref_flags.append("-D" + pref + "=" + userPrefs[pref])
    elif userPrefs[pref].startswith("water_sensor_mesh_"):
        pref_flags.append("-D" + pref + "=" + userPrefs[pref])
...
for lb in env.GetLibBuilders():
    if lb.name == "water_sensor_mesh-device-ui":
